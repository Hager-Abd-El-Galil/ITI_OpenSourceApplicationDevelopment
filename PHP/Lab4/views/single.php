                    ...
                    echo "<div class='hover-color-bubble'></div>
                            ...
                            <div class='card-description'>" .
                                ...
                                "<div class='ratings my-4'>
                                    ...
                                    <i class='fa fa-star two'></i>
                                    <i class='fa fa-star three'></i>
                                    <i class='fa fa-star four'></i>
                                    <i class='fa fa-star five'></i>
                                </div>
                        </div>
                    </div>
                </div>";
                 echo "<script type='text/JavaScript'>
                          var starOne = document.querySelector('.one');
                          var starTwo = document.querySelector('.two');
                          var starThree = document.querySelector('.three');
                          var starFour = document.querySelector('.four');
                          var starFive = document.querySelector('.five');

                          function displayRating(rate) {
                            if (rate > 0 && rate <= 1) {
                                starOne.classList.add('one', 'rating-color');
                            } else if (rate > 1 && rate <= 2) {
                                starOne.classList.add('one','rating-color');
                                starTwo.classList.add('two', 'rating-color');
                            } else if (rate > 2 && rate <= 3) {
                                starOne.classList.add('one', 'rating-color');
                                starTwo.classList.add('two', 'rating-color');
                                starThree.classList.add('three', 'rating-color');
                            } else if (rate > 3 && rate <= 4) {
                                starOne.classList.add('one', 'rating-color');
                                starTwo.classList.add('two', 'rating-color');
                                starThree.classList.add('three', 'rating-color');
                                starFour.classList.add('four', 'rating-color');
                            } else if (rate > 4 && rate <= 5) {
                                starOne.classList.add('one', 'rating-color');
                                starTwo.classList.add('two', 'rating-color');
                                starThree.classList.add('three', 'rating-color');
                                starFour.classList.add('four', 'rating-color');
                                starFive.classList.add('five', 'rating-color');
                            }
                          }
