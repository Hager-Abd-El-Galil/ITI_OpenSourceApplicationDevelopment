 ...
 *
 * @package 	digital_services
 * @author		The Theme Foundry
 */

if ( ! function_exists( 'online_courses_get_font_choices' ) ) :
/**
 ...
 */
function online_courses_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'online-courses' ) ) ) );
	$standard_fonts = online_courses_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'online-courses' ) ) ) );
	$google_fonts   = online_courses_get_google_fonts();
	 ...
	 */
	return apply_filters( 'online_courses_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
 ...
 * @return array    The fonts in value/label pairs.
 */
function online_courses_get_font_choices() {
	$fonts   = online_courses_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'online_courses_get_google_font_uri' ) ) :
/**
 ...
 */
function online_courses_get_google_font_uri( $fonts ) {

	// De-dupe the fonts
	$fonts         = array_unique( $fonts );
	$allowed_fonts = online_courses_get_google_fonts();
	$family        = array();
	...
	foreach ( $fonts as $font ) {
		...
		if ( array_key_exists( $font, $allowed_fonts ) ) {
			...
			$family[] = urlencode( $font . ':' . join( ',', online_courses_choose_google_font_variants( $font, $allowed_fonts[ $font ]['variants'] ) ) );
		}
	}
	...
	$subset = get_theme_mod( 'font-subset', online_courses_get_default( 'font-subset' ) );

	if ( 'all' === $subset ) {
		$subsets_available = online_courses_get_google_font_subsets();
...
if ( ! function_exists( 'online_courses_get_google_font_subsets' ) ) :
/**
 ...
 */
function online_courses_get_google_font_subsets() {
	return array(
		'all'          => esc_html__( 'All', 'online-courses' ),
		'cyrillic'     => esc_html__( 'Cyrillic', 'online-courses' ),
		'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'online-courses' ),
		'devanagari'   => esc_html__( 'Devanagari', 'online-courses' ),
		'greek'        => esc_html__( 'Greek', 'online-courses' ),
		'greek-ext'    => esc_html__( 'Greek Extended', 'online-courses' ),
		'khmer'        => esc_html__( 'Khmer', 'online-courses' ),
		'latin'        => esc_html__( 'Latin', 'online-courses' ),
		'latin-ext'    => esc_html__( 'Latin Extended', 'online-courses' ),
		'vietnamese'   => esc_html__( 'Vietnamese', 'online-courses' ),
	);
}
endif;

if ( ! function_exists( 'online_courses_choose_google_font_variants' ) ) :
/**
 ...
 */
function online_courses_choose_google_font_variants( $font, $variants = array() ) {
	$chosen_variants = array();
	if ( empty( $variants ) ) {
		$fonts = online_courses_get_google_fonts();
	...
	return apply_filters( 'online_courses_font_variants', array_unique( $chosen_variants ), $font, $variants );
}
endif;

if ( ! function_exists( 'online_courses_get_standard_fonts' ) ) :
/**
 ...
 */
function online_courses_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'online-courses' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'online-courses' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'online-courses' ),
...
if ( ! function_exists( 'online_courses_get_font_stack' ) ) :
/**
 ...
 */
function online_courses_get_font_stack( $font ) {

	$all_fonts = online_courses_get_all_fonts();

	// Sanitize font choice
	$font = online_courses_sanitize_font_choice( $font );
...
if ( ! function_exists( 'online_courses_sanitize_font_choice' ) ) :
/**
 ...
 */
function online_courses_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		// The array key is an integer, so the chosen option is a heading, not a real choice
		return '';
	} else if ( array_key_exists( $value, online_courses_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'online_courses_get_google_fonts' ) ) :
/**
 ...
 */
function online_courses_get_google_fonts() {
	return apply_filters( 'online_courses_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
