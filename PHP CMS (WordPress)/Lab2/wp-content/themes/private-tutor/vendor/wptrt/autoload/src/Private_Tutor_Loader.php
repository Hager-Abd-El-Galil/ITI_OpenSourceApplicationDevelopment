...
class Private_Tutor_Loader {
	 ...
	 * @return void
	 */
	public function private_tutor_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function private_tutor_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function private_tutor_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function private_tutor_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->private_tutor_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function private_tutor_load( $class ) {
